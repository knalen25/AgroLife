...
class BoiModelForm(forms.ModelForm):
    class Meta:
        model = Boi
        fields = [
            "brinco","chip","fornecedor","raca","sexo",
            "peso_entrada","data_nascimento","data_entrada","lote",
        ]
        widgets = {
    ...
    def save(self, commit=True):
        # Garante que todo boi novo fique 'Ativo' por padrão
        ativo = StatusBoi.objects.get(nome_status="Ativo")
        self.instance.status_boi = ativo
